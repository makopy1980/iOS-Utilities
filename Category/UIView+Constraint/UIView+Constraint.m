...
- (NSArray *)addConstraintFillWithInsets:(UIEdgeInsets)insets {
    ...
    NSArray *constraints1 = [self addConstraintFromTop:insets.top
                                              toBottom:insets.bottom];
    NSArray *constraints2 = [self addConstraintFromLeft:insets.left
                                                toRight:insets.right];
    NSArray *constraints = @[constraints1[0],
                             constraints2[0],
                             constraints1[1],
                             constraints2[1]
                             ];
...
- (NSLayoutConstraint *)addConstraintFromTop:(CGFloat)distance {
    ...
    return [self addConstraintWithVisualFormat:@"V:|-(distance)-[self]"
                                      distance:distance];
}

- (NSLayoutConstraint *)addConstraintFromBottom:(CGFloat)distance {
    
    return [self addConstraintWithVisualFormat:@"V:[self]-(distance)-|"
                                      distance:distance];
}

- (NSLayoutConstraint *)addConstraintFromLeft:(CGFloat)distance {
    
    return [self addConstraintWithVisualFormat:@"H:|-(distance)-[self]"
                                      distance:distance];
}

- (NSLayoutConstraint *)addConstraintFromRight:(CGFloat)distance {
    
    return [self addConstraintWithVisualFormat:@"H:[self]-(distance)-|"
                                      distance:distance];
}
...
- (NSLayoutConstraint *)addConstraintFromViewTop:(UIView *)fromView distance:(CGFloat)distance {
    ...
    return [self addConstraintFromView:fromView
                                format:@"V:[self]-(distance)-[fromView]"
                              distance:distance];
}
...
- (NSLayoutConstraint *)addConstraintFromViewBottom:(UIView *)fromView distance:(CGFloat)distance {
    ...
    return [self addConstraintFromView:fromView
                                format:@"V:[fromView]-(distance)-[self]"
                              distance:distance];
}
...
- (NSLayoutConstraint *)addConstraintFromViewLeft:(UIView *)fromView distance:(CGFloat)distance {
    ...
    return [self addConstraintFromView:fromView
                                format:@"H:[self]-(distance)-[fromView]"
                              distance:distance];
}
...
- (NSLayoutConstraint *)addConstraintFromViewRight:(UIView *)fromView distance:(CGFloat)distance {
    ...
    return [self addConstraintFromView:fromView
                                format:@"H:[fromView]-(distance)-[self]"
                              distance:distance];
}
...
- (NSLayoutConstraint *)addConstraintAlignViewTop:(UIView *)baseView offset:(CGFloat)offset {
    ...
    return [self addConstraintAlignView:baseView
